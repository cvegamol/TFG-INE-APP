          ...
          const obtenerDatos = async () => {
               try {
                    ...
                    const series = await Promise.all([
                         obtenerDatosSerie('MNP92517'),
                         obtenerDatosSerie('MNP81294630'),

                         obtenerDatosSerie('MNP92516'),
                         obtenerDatosSerie('MNP81294631'),

                         obtenerDatosSerie('MNP92515'),
                         obtenerDatosSerie('MNP81294632'),
                    ...
                    const formattedTableData = [
                         [
                              { label: 'Total de defunciones', value: 'Total de defunciones' },
                              {
                                   label: 'Valor',
                         ...
                         {isLoading ? (
                              ...
                              <>
                                   ...
                                   <TextStyled className="text-xl font-semibold text-teal-700 mb-4 text-center">
                                        ...
                                        Defunciones ocurridas en España - Año 2022
                                   </TextStyled>

                                   {/* Introducción breve */}
                                   <TextStyled className="text-base text-gray-700 mb-4">
                                        La tabla muestra las defunciones ocurridas en España en 2022, incluyendo los valores totales y las características sociodemográficas de las personas fallecidas.{"\n"}
                                        Los datos provienen del Certificado médico de defunción y están publicados por el INE.
                                   </TextStyled>
                                   <ResponsiveTable
                                             ...
                                             >
                                                  ...
                                                  >
                                                       <TextStyled className="text-base text-gray-800 leading-relaxed">
                                                            <TextStyled className="font-semibold">La Estadística de defunciones</TextStyled> se elabora desde 1858 y recoge los fallecimientos ocurridos en España, así como las características sociodemográficas de la persona fallecida.
                                                            {'\n\n'}
                                                            Esta estadística se realiza en colaboración con las comunidades autónomas, utilizando como fuente primaria el Certificado médico de defunción/Boletín estadístico de defunción, que es cumplimentado por el médico, el Registro Civil o, en ciertos casos especiales, el juzgado.
                                                       </TextStyled>
...
export default EstadisticasDefunciones;
