          ...
          const obtenerDatos = async () => {
               try {
                    ...
                    const series = await Promise.all([
                         obtenerDatosSerie('MNP162'),
                         obtenerDatosSerie('MNP81294625'),

                         obtenerDatosSerie('MNP160'),
                         obtenerDatosSerie('MNP81294626'),

                         obtenerDatosSerie('MNP161'),
                         obtenerDatosSerie('MNP81294627'),

                         obtenerDatosSerie('MNP80475152'),
                         obtenerDatosSerie('MNP81294628'),

                         obtenerDatosSerie('MNP80475151'),
                         obtenerDatosSerie('MNP81294629'),
                    ...
                    const formattedTableData = [
                         [
                              { label: 'Total de nacimientos', value: 'Total de nacimientos' },
                              {
                                   label: 'Valor',
                         ...
                         [
                              { label: 'De madre española', value: 'De madre española' },
                              {
                                   label: 'Valor',
                         ...
                         [
                              { label: 'De madre extranjera', value: 'De madre extranjera' },
                              {
                                   label: 'Valor',
                         ...
                         {isLoading ? (
                              ...
                              <>
                                   ...
                                   <TextStyled className="text-xl font-semibold text-teal-700 mb-4 text-center">
                                        Nacimientos ocurridos en España - Año 2022
                                   </TextStyled>

                                   {/* Introducción breve */}
                                   <TextStyled className="text-base text-gray-700 mb-4">
                                        La tabla muestra los nacimientos registrados en España en 2022, incluyendo los valores totales y la variación respecto al año anterior.{"\n"}
                                             ...
                                             >
                                                  ...
                                                  >
                                                       <TextStyled className="text-base text-gray-800 leading-relaxed">
                                                            <TextStyled className="font-semibold">La Estadística de nacimientos</TextStyled> se realiza desde 1858 y constituye uno de los trabajos de más tradición en el INE. Recoge la información de los nacimientos ocurridos en España, así como los datos relativos al parto y a los padres del nacido.
                                                            {'\n\n'}
...
export default EstadisticasNacimientos;
