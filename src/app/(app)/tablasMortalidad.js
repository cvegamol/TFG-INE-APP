          ...
          const obtenerDatos = async () => {
               try {
                    ...
                    const estadisticaPadronContinuo = await fetch(
                         `https://deploy-app-production-5893.up.railway.app/getOperationById/${id}`
                    ...
                    const series = await Promise.all([
                         obtenerDatosSerie('TM2177'),
                         obtenerDatosSerie('TM1449'),
                         obtenerDatosSerie('TM721'),

                         obtenerDatosSerie('TM1657'),
                         obtenerDatosSerie('TM929'),
                         obtenerDatosSerie('TM201'),

                         obtenerDatosSerie('TM2184'),
                         obtenerDatosSerie('TM1456'),
                         obtenerDatosSerie('TM728'),

                         obtenerDatosSerie('TM1664'),
                         obtenerDatosSerie('TM936'),
                         obtenerDatosSerie('TM208'),
                    ...
                    const formattedTableData = [
                         ...
                         [
                              { label: 'Esperanza de vida a los 65 años', value: 'Esperanza de vida a los 65 años' },
                              {
                                   label: 'Total',
                         ...
                         [
                              { label: 'Tasa de mortalidad al nacimiento', value: 'Tasa de mortalidad al nacimiento' },
                              {
                                   label: 'Total',
                         ...
                         [
                              { label: 'Tasa de mortalidad a los 65 años', value: 'Tasa de mortalidad a los 65 años' },
                              {
                                   label: 'Total',
                         ...
                         {isLoading ? (
                              ...
                              <>
                                   ...
                                   <TextStyled className="text-xl font-semibold text-teal-700 mb-4 text-center">
                                        Funciones biométricas - Año 2022
                                   </TextStyled>


                                   <ResponsiveTable
                                        headers={['', 'Total', 'Hombres', 'Mujeres']}
                                        data={tablaDatos}
                                        responsive={true}
                                   ...
                                   >
                                        ...
                                        >
                                             Tablas de mortalidad por año, sexo, edad y funciones.
                                        </TextStyled>
                                        <Ionicons
                                   ...
                                   {isExpanded && (
                                        <ViewStyled style={{ marginLeft: 20 }}>
                                             ...
                                             <TouchableOpacityStyled
                                                  ...
                                                  onPress={() => handlePressTabla(27153)}
                                                  style={{
                                             ...
                                             >
                                                  ...
                                                  <TextStyled style={{ color: '#ffffff', fontSize: 14, fontWeight: '500' }}>
                                                       Resultados nacionales, por comunidades autónomas y provincias. Series desde 1991.
                                                  </TextStyled>
                                             </TouchableOpacityStyled>
                                             ...
                                             <TouchableOpacityStyled
                                                  className="p-2 my-2 rounded-lg"
                                                  onPress={() => handlePressTabla(27150)}
                                                  style={{
                                                       backgroundColor: '#4fd1c5', // Color teal más claro
                                                       shadowColor: '#000',
                                                       shadowOffset: { width: 0, height: 1 },
                                             ...
                                             >
                                                  ...
                                                  <TextStyled style={{ color: '#ffffff', fontSize: 14, fontWeight: '500' }}>
                                                       ...
                                                       Resultados nacionales, por comunidades autónomas y provincias. Series 1975 - 1990.
                                                  </TextStyled>
                                             </TouchableOpacityStyled>
                                        </ViewStyled>
                                   )}
                                   ...
                                   >
                                        ...
                                        >
                                             Tablas de mortalidad por año, provincia, sexo, edad y funciones.
                                        </TextStyled>
                                        <Ionicons
                                   ...
                                   {isExpanded2 && (
                                        <ViewStyled style={{ marginLeft: 20 }}>
                                             ...
                                             <TouchableOpacityStyled
                                                  className="p-2 my-2 rounded-lg"
                                                  onPress={() => handlePressTabla(27155)}
                                                  style={{
                                                       backgroundColor: '#4fd1c5', // Color teal más claro
                                                       shadowColor: '#000',
                                                       shadowOffset: { width: 0, height: 1 },
                                             ...
                                             >
                                                  <Ionicons name="document-outline" size={18} color="white" style={{ marginRight: 10 }} />
                                                  <TextStyled style={{ color: '#ffffff', fontSize: 14, fontWeight: '500' }}>
                                                       Resultados nacionales, por comunidades autónomas y provincias. Series desde 1991.                                                  </TextStyled>
                                             </TouchableOpacityStyled>

                                             {/* Segunda tabla expandida */}
                                             <TouchableOpacityStyled
                                                  className="p-2 my-2 rounded-lg"
                                                  onPress={() => handlePressTabla(27152)}
                                                  style={{
                                                       backgroundColor: '#4fd1c5', // Color teal más claro
                                                       shadowColor: '#000',
                                                       shadowOffset: { width: 0, height: 1 },
                                             ...
                                             >
                                                  <Ionicons name="document-outline" size={18} color="white" style={{ marginRight: 10 }} />
                                                  <TextStyled style={{ color: '#ffffff', fontSize: 14, fontWeight: '500' }}>
                                                       Resultados nacionales, por comunidades autónomas y provincias. Series 1975 - 1990.                                                  </TextStyled>
                                             </TouchableOpacityStyled>
                                        </ViewStyled>
                                   )}
                                   ...
                                   >
                                        ...
                                        >
                                             Tablas de mortalidad por año, comunidades y ciudades autónomas, sexo, edad y funciones.                                             </TextStyled>
                                        <Ionicons
                                             name={isExpanded3 ? "chevron-up-outline" : "chevron-down-outline"}
                                             size={24}
                                             color="white"
                                             style={{ marginLeft: 'auto' }}
                                        />
                                   ...
                                   {isExpanded3 && (
                                        <ViewStyled style={{ marginLeft: 20 }}>
                                             ...
                                             <TouchableOpacityStyled
                                                  className="p-2 my-2 rounded-lg"
                                                  onPress={() => handlePressTabla(27154)}
                                                  style={{
                                                       backgroundColor: '#4fd1c5', // Color teal más claro
                                                       shadowColor: '#000',
                                                       shadowOffset: { width: 0, height: 1 },
                                             ...
                                             <TouchableOpacityStyled
                                                  className="p-2 my-2 rounded-lg"
                                                  onPress={() => handlePressTabla(27151)}
                                                  style={{
                                                       backgroundColor: '#4fd1c5', // Color teal más claro
                                                       shadowColor: '#000',
                                                       shadowOffset: { width: 0, height: 1 },
                                             ...
                                             >
                                                  ...
                                                  >
                                                       <TextStyled className="text-base text-gray-800 leading-relaxed">
                                                            <TextStyled className="font-semibold">Las Tablas de mortalidad</TextStyled> se componen de series biométricas como el riesgo de muerte, los supervivientes y la esperanza de vida, y se calculan para medir la incidencia de la mortalidad en una población, permitiendo analizar su evolución en el tiempo y el espacio.
                                                            {'\n\n'}
                                                            Constituyen una tarea tradicional del INE desde 1945, elaboradas a partir de los desarrollos metodológicos más pertinentes según los datos disponibles de defunciones y población.
                                                       </TextStyled>
...
export default TablasMortalidad;
