                                             ...
                                             >
                                                  ...
                                                  >
                                                       <TextStyled className="text-base text-gray-800 leading-relaxed">
                                                            <TextStyled className="font-semibold">Las Proyecciones de población</TextStyled> Las Proyecciones de población proporcionan una simulación de la población residente en España para los próximos años, desagregada según características demográficas básicas.{"\n\n"}
                                                            Estas proyecciones permiten tener una visión actualizada de la posible realidad demográfica futura, tomando en cuenta la evolución demográfica reciente y simulando los efectos de las tendencias demográficas presentes.{"\n\n"}
                                                            Se actualizan cada 2 años y abarcan un horizonte de 50 años para el total nacional y 15 años para comunidades autónomas y provincias. A partir de 2018, también se incluyen Indicadores demográficos básicos proyectados, como la natalidad, fecundidad, mortalidad, indicadores migratorios, y de crecimiento y estructura poblacional.{"\n\n"}
                                                       </TextStyled>
...
export default ProyeccionesPoblacion;
